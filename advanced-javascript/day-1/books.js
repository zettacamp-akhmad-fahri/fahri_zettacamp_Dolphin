...
function bookPurchase (books, shoppingCart) {
    ...
    calculateInstallment(grandTotal, creditDuration, output)
...
function calculateInstallment (grandTotal, creditDuration, output) {
    ...
    output.push({
        ...
        monthlyPayment: grandTotal / creditDuration,
        dueDates: dateArray
    })
